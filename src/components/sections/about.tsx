  ...
  return (
    <section className="container mx-auto px-4  ">
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6 bg-slate-50 p-8 rounded-lg">
      ...
      {/* Values Section */}
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div className="space-y-6 bg-slate-50 p-8 rounded-lg md:order-1">
          <div className="space-y-4">
            <p className="text-sm font-semibold text-muted-foreground">
              Why DigiSolv?
            </p>
        ...
        <div className="relative aspect-video md:aspect-square w-full md:order-2">
          <img
